...
export const TECH_STACK_COPY = {
  ...
  competitor: {
    ...
    noPainLabel: NO_PAIN,
    reachLabel: "How patients find you and book",
    reachHint: "Two taps. This is a fifth of your score on its own.",
    onlineBooking: "Patients can book without phoning us",
    asksForReviews: "We ask for a review after the visit",
    cta: "Continue",
    skip: "Skip this",
  },
} as const;
